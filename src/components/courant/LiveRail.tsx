...
function TonightStatusCard({ settings }: { settings: Settings | null }) {
    ...
    return (
        <button
            ...
            className={`w-full cursor-pointer  border p-4 text-left transition-all hover:shadow-md hover:scale-[1.01] active:scale-[0.99] ${c.bg} ${c.glow}`}
        >
            ...
            <div className="mt-3 flex items-center justify-center gap-1.5 bg-primary/10 py-1.5 text-xs font-semibold text-primary transition-colors hover:bg-primary/20">
                📅 Reserveer nu
            </div>
        </button>
    );
...
function ReviewQuoteRotator({
    ...
    return (
        <div className="border border-border/50 bg-foreground/[0.03] p-4">
            {/* ── Google Overall Rating Card ── */}
            {googleRating > 0 && (
                <div className="mb-3 border border-amber-500/20 bg-amber-500/[0.04] px-3 py-2.5">
                    ...
                    >
                        ...
                        {(() => {
                            try {
                                ...
                                return (
                                    <div className="mt-3 border border-primary/10 bg-primary/5 p-2.5">
            ...
            <div className="space-y-2 overflow-visible">
                {items.slice(0, 3).map((item, i) => (
                    <a
                        ...
                        className="group block border-2 border-foreground bg-white p-3 transition-shadow duration-300 hover:shadow-[4px_4px_0_hsl(var(--foreground))]"
                    >
