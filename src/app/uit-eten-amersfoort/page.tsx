...
export const metadata: Metadata = {
    ...
    description:
        "Uit eten in Amersfoort? De Tafelaar: shared dining met lokale gerechten op de Kamp. Gezellig samen aan tafel, gerechten om te delen. Reserveer nu.",
    alternates: {
...
function buildFaqs(g: GoogleRating) {
    return [
    {
        ...
        answer: `De Tafelaar op de Kamp 8 is een aanrader als je lekker wilt eten in Amersfoort. Je deelt gerechten aan tafel, van borrelplanken en charcuterie tot warme seizoensgerechten. Gemaakt met lokale producten, gezellige sfeer, en een ${g.ratingText} op Google. Open woensdag t/m zondag.`,
    },
    {
        ...
        <>
            ...
            <header className="mb-12 border-[5px] border-foreground bg-white px-6 py-10 text-center sm:px-10 sm:py-12">
                ...
                <p className="mt-4 max-w-2xl mx-auto text-base sm:text-lg text-muted-foreground">
                    ...
                    deel je gerechten aan tafel. Lokaal, seizoensgebonden en gemaakt met liefde.
                </p>
            </header>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Card className="border-2 border-foreground">
                        ...
                        <CardContent className="text-sm text-muted-foreground">
                            Bestel gerechten en deel alles aan tafel. Proef meer, geniet samen.
                        </CardContent>
                    </Card>
                ...
                <Card className="border-2 border-foreground p-6 sm:p-8">
                    ...
                    <div className="space-y-4 text-muted-foreground">
                        <p>
                            ...
                            genieten: je bestelt gerechten die je deelt aan tafel. Zo proef je
