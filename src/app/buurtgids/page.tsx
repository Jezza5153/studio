...
export const metadata: Metadata = {
  title: "Buurtgids Flint & Kamp | Eten vlakbij de Flint Amersfoort",
  description:
    "Op zoek naar eten dichtbij de Flint? De Tafelaar ligt op 5 minuten lopen. Ontdek de beste restaurants nabij Flint, parkeren en hotspots op de Kamp in Amersfoort.",
  alternates: {
    canonical: "/buurtgids",
  },
  openGraph: {
...
const buurtgidsFaqs = [
  {
    question: "Welk restaurant ligt het dichtst bij de Flint Amersfoort?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Zeker! We raden aan om rond 17:15 of 17:45 te reserveren als je voor een voorstelling wilt eten. Onze shared dining gerechten zijn snel te serveren zodat je op tijd in het theater zit. Gerechten kosten €3,50-€15.",
  },
];
          ...
          <Card className="border-2 border-foreground p-6 sm:p-8">
            <div className="space-y-4 text-muted-foreground">
              <p>
                ...
                slechts 5 minuten lopen van Theater de Flint. Wij serveren gerechten om te
              ...
              <p>
                ...
                voor een vroeg diner of een rustige borrel. Gerechten kosten €3,50-€15, een
